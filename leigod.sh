...
show_openwrt_suggestion() {
  ...
  Tproxy模式: 
  opkg update 
  opkg install libpcap iptables kmod-ipt-nat iptables-mod-tproxy kmod-ipt-tproxy kmod-netem tc-full kmod-ipt-ipset ipset curl
...
show_install_success() {
  ...
  echo "雷神路由器插件安装已完成"
  echo "对应的测试手机App, 请加群482562157下载"
}
